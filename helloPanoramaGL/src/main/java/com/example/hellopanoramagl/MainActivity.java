		...
		try
		{
			...
			switch(index)
	    	{
		    	...
		    	case 0:
					...
					break;
		    	//Spherical2 panorama (supports up 2048x1024 image) quito1_s2
		    	case 1:
		    		panorama = new PLSpherical2Panorama();
		            ((PLSpherical2Panorama)panorama).setImage(new PLImage(PLUtils.getBitmap(context, R.raw.kidsbedroom), false));
		            break;
            	//Spherical panorama (supports up 1024x512 image)
		    	case 2:
		    		panorama = new PLSphericalPanorama();
					((PLSphericalPanorama)panorama).setImage(new PLImage(PLUtils.getBitmap(context, R.raw.test1), false));
					break;
...
//					quito1_s_beifan
		        	cylindricalPanorama.setImage(new PLImage(PLUtils.getBitmap(context, R.raw.test), false));
	    	...
	    	{
	    		//Set camera rotation
	    		panorama.getCamera().lookAt(0.0f,190.0f);
		        //Add a hotspot
		        panorama.addHotspot(new PLHotspot(1, new PLImage(PLUtils.getBitmap(context, R.raw.hotspot), false), 9.0f, 50.0f, 0.05f, 0.05f));
		        //Reset view
		        this.reset();
		        //Load panorama
		...
		try
    	{
    		...
    		switch(index)
    		{
	    		...
	    		case 1:
	    			...
	    			break;
	    		case 2:
	    			loader = new PLJSONLoader("res://raw/json_test_spherical");
	    			break;
	    		case 3:
    		...
    		if(loader != null)
    			this.load(loader, true, new PLTransitionBlend(5.0f));
    	}
    	catch(Throwable e)
    	{
    		Toast.makeText(this.getApplicationContext(), "Error: " + e, Toast.LENGTH_SHORT).show();
